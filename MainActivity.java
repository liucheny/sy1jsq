...
public class MainActivity extends Activity implements View.OnClickListener{
    ...
    private int[] ids = new int[]{R.id.bt1,R.id.bt2,R.id.bt3,R.id.bt4,R.id.bt5,R.id.bt6,R.id.bt7,
            R.id.bt8,R.id.bt9,R.id.btn_del,R.id.btn_sub,R.id.btn_clr,R.id.btn_add,R.id.btn_cos,R.id.btn_div,R.id.btn_eq,R.id.btn_pt,R.id.btn_sin,
            R.id.btn_mul,R.id.btn_0,R.id.jinzhi2,R.id.jinzhi16,R.id.btn_tan,R.id.m,R.id.m2
    };
    ...
    public void onClick(View view) {
        ...
        if(current.equals("归零")){ //如果为CE则清零
            expression = "";
            countOperate=0;
        }else if(current.equals("删除")){ //如果点击退格
